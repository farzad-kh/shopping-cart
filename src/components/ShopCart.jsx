...
import { CartContext,OfferTenContext } from '../context/CartContextProvider';
...
const ShopCart = ({ title, price, image, id, rate, quantity }) => {
    const {  state,dispatch } = useContext(CartContext)
    const {  offerTen} = useContext(CartContext)
